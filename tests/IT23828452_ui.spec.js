...
function excelPaths() {
    // TODO: Update the filename if your new Excel sheet has a different name
    const original = path.join(__dirname, "..", "test-data", "IT23828452.xlsx");
    const executed = path.join(__dirname, "..", "test-data", "IT23828452_EXECUTED.xlsx");
...
test.describe("IT23828452 - UI cases", () => {
    const updates = [];
    let outPath = "";
